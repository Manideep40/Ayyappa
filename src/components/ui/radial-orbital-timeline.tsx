...
export default function RadialOrbitalTimeline({ timelineData, className, height }: RadialOrbitalTimelineProps) {
  ...
  return (
    <div
      className={`w-full flex flex-col items-center justify-center bg-black overflow-hidden ${className ?? "h-[32rem]"}`}
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  } transition-all duration-300 transform ${isExpanded ? "scale-150" : ""}`}
                >
                  <Icon size={16} />
                </div>
