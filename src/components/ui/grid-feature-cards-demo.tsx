...
export default function DemoGridFeatureCards() {
  return (
...
type ViewAnimationProps = { delay?: number; className?: React.ComponentProps<typeof motion.div>['className']; children: React.ReactNode }
